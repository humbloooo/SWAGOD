            ...
            <div className="container mx-auto">
                <div className="flex justify-between items-center mb-12">
                    ...
                    <button
                        ...
                        className="px-6 py-3 bg-primary text-background font-bold uppercase hover:bg-foreground transition-colors"
                    >
                        + ADD ITEM
                    </button>
                </div>
                    ...
                    {isEditing && (
                        <div className="fixed inset-0 bg-background/90 backdrop-blur-xl z-[100] flex items-center justify-center p-4">
                            <motion.div
                                ...
                                className="bg-background border border-foreground/20 p-8 max-w-xl w-full relative"
                            >
                                ...
                                <form onSubmit={handleSubmit} className="space-y-4 font-mono text-sm uppercase">
                                    <div>
                                        ...
                                        <input
                                            className="w-full bg-foreground/5 border border-foreground/10 p-3 outline-none focus:border-primary transition-colors"
                                            value={newItem.title || ""}
                                    ...
                                    <div>
                                        <label className="block mb-1 text-foreground/40">IMAGE</label>
                                        <ImageUpload
                                            value={newItem.image}
                                        ...
                                        />
                                        <input
                                            className="w-full bg-foreground/5 border border-foreground/10 p-2 mt-2 text-[10px] text-foreground/40 outline-none"
                                    ...
                                    <div>
                                        <label className="block mb-1 text-foreground/40">DESCRIPTION</label>
                                        <textarea
                                            className="w-full bg-foreground/5 border border-foreground/10 p-3 h-24 outline-none focus:border-primary transition-colors resize-none"
                                    ...
                                    <div className="flex justify-end gap-4 mt-6">
                                        <button type="button" onClick={() => setIsEditing(false)} className="px-6 py-2 border border-foreground/20 uppercase font-black tracking-widest hover:bg-foreground/5 transition-colors">CANCEL</button>
                                        <button type="submit" className="px-6 py-2 bg-primary text-background uppercase font-black tracking-widest hover:bg-foreground transition-colors">SAVE</button>
                                    </div>
                                </form>
                            </motion.div>
                        </div>
                            ...
                            <div className="absolute bottom-0 left-0 bg-background/80 backdrop-blur-md text-foreground p-3 text-[10px] w-full flex flex-col gap-1">
                                ...
                                <div className="flex justify-between items-center">
                                    ...
                                    <button
                                        ...
                                        className="text-red-500 hover:text-foreground transition-colors font-black"
                                    >
                                        [DEL]
                                    </button>
                                </div>
